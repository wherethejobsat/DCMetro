...
- Include December 2025 source/reference material.
- Update Blue/Yellow trunk and Yellow Line extension data.
- Add public static app metadata, service worker behavior, README launch copy, data provenance, issue templates, release checklist, and MIT license.

## 2025.06 data

- Include June 2025 source/reference material and generated static app output.
